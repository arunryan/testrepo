/**
 * Optimized Sum Calculator (Updated from InefficientSum)
 * 
 * This class demonstrates efficient ways to calculate sums of natural numbers.
 * Originally inefficient, now optimized with multiple algorithms and benchmarking.
 * 
...
public class InefficientSum {
    ...
    public static void main(String[] args) {
        ...
        // Method 3: Using arithmetic progression formula (fastest)
        startTime = System.nanoTime();
        ...
        if (inefficientTime > 0) {
            double improvement = (double) inefficientTime / arithmeticTime;
    ...
    /**
     * Original inefficient helper method (kept for comparison)
     */
